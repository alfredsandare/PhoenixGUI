...
dropdown = Dropdown((300, 600), (100, 30), "arial", 20, ["Johannes", "Bingus", "Bongus", "Bungus"], "Johannes", box_bg_color=(0, 0, 255), box_outline_color=(255, 255, 255), box_bg_hover_color=(0, 0, 200), box_outline_hover_color=(255, 255, 255), box_bg_click_color=(0, 0, 150), box_outline_click_color=(255, 255, 255), command=lambda _: print("omegalul"))
...
text2 = Text([300, 300], "Hello lorem ipsum dolor%%0 255 0%There lorem ipsum\\%\n%Hello again", "arial", 20, color=(255, 0, 0), wrap_lines=True, anchor="se")
